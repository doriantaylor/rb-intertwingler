...
module RDF::SAK
  ...
  class CI < RDF::StrictVocabulary("https://privatealpha.com/ontology/content-inventory/1#")
    ...
    ontology :"https://privatealpha.com/ontology/content-inventory/1#",
      ...
      "dc:creator": ["http://doriantaylor.com/person/dorian-taylor#me".freeze, "https://doriantaylor.com/person/dorian-taylor#me".freeze],
      "dc:modified": ["2012-12-11T22:22:00-08:00".freeze, "2014-02-06T14:10:00-08:00".freeze, "2015-02-03T14:39:00-08:00".freeze, "2017-04-06T15:24:00-07:00".freeze, "2018-10-06T16:23:52Z".freeze],
      "dc:title": "A Content Inventory Vocabulary".freeze,
      "http://purl.org/vocab/vann/preferredNamespacePrefix": "ci".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["bibo:".freeze, "dc:".freeze, "foaf:".freeze, "http://creativecommons.org/licenses/by/2.5/ca/".freeze, "http://doriantaylor.com/person/dorian-taylor#me".freeze, "http://en.wikipedia.org/wiki/Content_strategy".freeze, "http://en.wikipedia.org/wiki/Five-number_summary".freeze, "http://en.wikipedia.org/wiki/Mean".freeze, "http://en.wikipedia.org/wiki/Standard_deviation".freeze, "http://publishing-statistical-data.googlecode.com/svn/trunk/specs/src/main/html/cube.html#ref_qb_DataStructureDefinition".freeze, "http://publishing-statistical-data.googlecode.com/svn/trunk/specs/src/main/html/cube.html#ref_qb_DimensionProperty".freeze, "http://publishing-statistical-data.googlecode.com/svn/trunk/specs/src/main/html/cube.html#ref_qb_MeasureProperty".freeze, "http://publishing-statistical-data.googlecode.com/svn/trunk/specs/src/main/html/cube.html#ref_qb_Observation".freeze, "http://purl.org/NET/c4dm/event.owl#".freeze, "http://purl.org/linked-data/cube#".freeze, "http://vocab.org/frbr/core".freeze, "http://vocab.org/frbr/extended".freeze, "http://www.w3.org/TR/vocab-data-cube/".freeze, "http://www.w3.org/TR/vocab-data-cube/#ref_qb_DataSet".freeze, "https://doriantaylor.com/person/dorian-taylor#me".freeze],
    ...
    term :Action,
      ...
      "https://privatealpha.com/ontology/content-inventory/external": "http://purl.org/NET/c4dm/event.owl#Event".freeze,
      isDefinedBy: "ci:".freeze,
      label: "Action".freeze,
    ...
    property :action,
      ...
      "https://privatealpha.com/ontology/content-inventory/external": ["foaf:Document".freeze, "http://purl.org/NET/c4dm/event.owl#factor_of".freeze],
      isDefinedBy: "ci:".freeze,
      label: "action".freeze,
    ...
    property :assumes,
      ...
      domain: "foaf:Document".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["dc:educationLevel".freeze, "dc:references".freeze, "foaf:Document".freeze, "skos:Concept".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :block,
      ...
      "https://privatealpha.com/ontology/content-inventory/external": ["http://purl.org/linked-data/cube#Observation".freeze, "xsd:nonNegativeInteger".freeze],
      isDefinedBy: "ci:".freeze,
      label: "blocks".freeze,
    ...
    property :canonical,
      ...
      "https://privatealpha.com/ontology/content-inventory/external": "owl:sameAs".freeze,
      isDefinedBy: "ci:".freeze,
    ...
    property :"canonical-slug",
      ...
      "https://privatealpha.com/ontology/content-inventory/external": "xsd:string".freeze,
      isDefinedBy: "ci:".freeze,
    ...
    property :characters,
      ...
      domain: "http://purl.org/linked-data/cube#Observation".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["http://purl.org/linked-data/cube#Observation".freeze, "http://www.w3.org/TR/xpath/#function-normalize-space".freeze, "xsd:nonNegativeInteger".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :"desired-outcome",
      ...
      domain: "foaf:Document".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["dc:type".freeze, "foaf:Document".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :document,
      ...
      domain: "http://purl.org/linked-data/cube#Observation".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["foaf:Document".freeze, "http://purl.org/linked-data/cube#Observation".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :embed,
      ...
      domain: "foaf:Document".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["dc:hasPart".freeze, "foaf:Document".freeze],
      isDefinedBy: "ci:".freeze,
      label: "embed".freeze,
    ...
    property :"high-quartile",
      ...
      domain: "http://purl.org/linked-data/cube#Observation".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["http://en.wikipedia.org/wiki/Quartile".freeze, "http://purl.org/linked-data/cube#Observation".freeze, "xsd:number".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :indegree,
      ...
      domain: "http://purl.org/linked-data/cube#Observation".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["http://en.wikipedia.org/wiki/Directed_graph#Indegree_and_outdegree".freeze, "http://purl.org/linked-data/cube#Observation".freeze, "xsd:number".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :introduces,
      ...
      domain: "foaf:Document".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["foaf:Document".freeze, "skos:Concept".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :link,
      ...
      domain: "foaf:Document".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["dc:references".freeze, "foaf:Document".freeze],
      isDefinedBy: "ci:".freeze,
      label: "link".freeze,
      subPropertyOf: "dc:references".freeze,
      type: "owl:ObjectProperty".freeze
    ...
    property :max,
      ...
      domain: "http://purl.org/linked-data/cube#Observation".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["http://en.wikipedia.org/wiki/Sample_maximum".freeze, "http://purl.org/linked-data/cube#Observation".freeze, "xsd:number".freeze],
      isDefinedBy: "ci:".freeze,
      label: "max".freeze,
      range: "xsd:number".freeze,
    ...
    property :mean,
      comment: %(Mean).freeze,
      domain: "http://purl.org/linked-data/cube#Observation".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["http://en.wikipedia.org/wiki/Sample_minimum".freeze, "http://purl.org/linked-data/cube#Observation".freeze, "xsd:number".freeze],
      isDefinedBy: "ci:".freeze,
      label: "mean".freeze,
      range: "xsd:number".freeze,
    ...
    property :median,
      ...
      domain: "http://purl.org/linked-data/cube#Observation".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["http://en.wikipedia.org/wiki/Median".freeze, "http://purl.org/linked-data/cube#Observation".freeze, "xsd:number".freeze],
      isDefinedBy: "ci:".freeze,
      label: "median".freeze,
      range: "xsd:number".freeze,
    ...
    property :mentions,
      ...
      domain: "foaf:Document".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["dc:references".freeze, "foaf:Document".freeze, "skos:Concept".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :"non-audience",
      ...
      domain: "foaf:Document".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["dc:AgentClass".freeze, "dc:audience".freeze, "foaf:Document".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :sections,
      ...
      domain: "foaf:Document".freeze,
      "https://privatealpha.com/ontology/content-inventory/external": ["foaf:Document".freeze, "xsd:nonNegativeInteger".freeze],
      isDefinedBy: "ci:".freeze,
    ...
    property :target,
      ...
      "https://privatealpha.com/ontology/content-inventory/external": "foaf:Document".freeze,
      isDefinedBy: "ci:".freeze,
      label: "target".freeze,
      range: "foaf:Document".freeze,
      type: "owl:ObjectProperty".freeze
